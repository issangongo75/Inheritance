...
#define SHAPE_GIVE_PARAMETERS start_x, start_y, line_width, color
	...
	public:
		...
		{
			this->side = filter_size(side);
			if (this->side <= base / 2)this->side = base / 7 * 2;
		}
...
void main()
{
	...
	Geometry::Square square(150, 130, 100, 5, Geometry::Color::RED);
	...
	Geometry::Rectangle rect(100, 50, 200, 200, 10, Geometry::Color::BLUE);
	rect.info();

	Geometry::Circle disk(150, 500, 200, 5, Geometry::Color::YELLOW);
	disk.info();
	Geometry::EquilateralTriangle e_trinagle(150, 300, 100, 5, Geometry::Color::GREEN);
	e_trinagle.info();

	Geometry::IsoscelesTriangle iso_triangle(200, 100, 400, 500, 50, Geometry::Color::GREEN);
	iso_triangle.info();

	cout << "Количество фигурЖ " << disk.get_count() << endl;
